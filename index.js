const contentLetterSrart_actived = "Chào bạn! Hãy mở hộp quà này ra sẽ có bất ngờ" //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc Nqoc Trann sinh nhật vui vẻ. Chúc bạn có một ngày tràn đầy niềm vui và hạnh phúc. Mong rằng những điều tốt đẹp nhất sẽ đến với bạn trong năm mới của tuổi mới. Hãy luôn mạnh khỏe, hạnh phúc và thành công trong mọi lĩnh vực của cuộc sống. Sinh nhật vui vẻ" //Nội dung của bức thư
